...
import { BarChart3, Clock, Mic, Users } from "lucide-react";
    ...
    return (
        <div>
            ...
            <main className="flex-1 items-center justify-center">
                {/* Hero Section */}
                <section className="py-20 flex items-center justify-center w-full md:py-28 bg-linear-to-b from-blue-50 to-white">
